...
- [`shop-pc-hub.md`](./shop-pc-hub.md) — **Main shop PC** as recurring multi-use hub (parts / customers / air / …)
...
- **Main Shop PC hub** — sticky-note login, menu of tools players return to — see [`shop-pc-hub.md`](./shop-pc-hub.md).
...
Access backbone: Main → Storage → Office; last major container = car trunk. **Shop PC hub pinned in Main.** Suspicion curve locked ([`suspicion-curve.md`](./suspicion-curve.md)). Multi-layer trunk proposed. Assist: [`adaptive-difficulty.md`](./adaptive-difficulty.md).
