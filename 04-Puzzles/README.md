...
- **Multi-layered/distributed preferred**: favor puzzles that hand out partial pieces across different rooms/containers which only combine back at an earlier location — see flagship **car trunk** proposal in [`../03-Flow/puzzle-dependency-map.md`](../03-Flow/puzzle-dependency-map.md). Use room/container language from [`../02-Room-Design/zones-and-containers.md`](../02-Room-Design/zones-and-containers.md) (three rooms: Main / Storage / Office).
...
Theme brainstorm started: [`theme-brainstorm-v1.md`](./theme-brainstorm-v1.md) (15+ concepts + path-tracing cogs, no solutions locked). Whittle next, then formal puzzle folders.
