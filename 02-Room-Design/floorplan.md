...
![Tony's Garage floorplan v1](../06-Assets/references/floorplan-v1-hand-sketch.png)
...
### Storage Closet (top-right, enclosed) — accessed first
...
### Office (bottom-left, enclosed) — accessed second

- Its own four walls, with a door (swing shown) connecting to the Main Garage Bay.
- Labeled with a second **"Mechanic Station"** at the top of the room, and **"Office"** (underlined) as the specific area within it containing:
  - Desk
  - 2–3 chairs
...
- Confirmed contents: a labeled photo of Chief **Dawn Adams**, which completes the name-triangulation with the Storage Closet's handshake photo (see [`../01-Story/narrative-arc.md`](../01-Story/narrative-arc.md)). Also likely home for personal paperwork (calendar, ledger).

### Tools Closet (right side, narrow, enclosed) — **container**, not a zone

- Under the project's zone vocabulary, this is a **container** (or sub-area of Main), not a 4th zone. Confirm with Russell if needed — see [`zones-and-containers.md`](./zones-and-containers.md).
